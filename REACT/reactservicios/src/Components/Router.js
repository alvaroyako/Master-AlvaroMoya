            ...
            <div>
                ...
                <MenuDepartamentos/>
                    <Switch>
                        ...
                        <Route exact path="/createdepartamento" component={InsertarDepartamento}/>
                        ...
                        render={props=>{
                            ...
                            return(
                                <UpdateDepartamento iddepartamento={deptno}/>
                            )
                        }}/>
                        ...
                        render={props=>{
                            ...
                            var loc=props.match.params.localidad;
                            return(
                                <EliminarDepartamento iddepartamento={num} nombre={nom} localidad={loc}/>
                            )
                        }}/>

                        {/* <Route exact path="/detallesempleado/:idempleado" render={
                            props=>{
                    ...
                    {/* <EmpleadosRouter> </EmpleadosRouter> */}
                </BrowserRouter>
            </div>
        )
    }
